...
\begin{document}
    ...
    \section{\ru{Работа}\en{Work}}
        ...
        {\ru{Разработка на Python}\en{Python development}: 
        	\begin{itemize}
        		\item \ru{Реализация и бэктестинг трейдинговых стратегий на Python3}\en{TODO}.
        	\end{itemize}
        }
        ...
        {\ru{Факультет Вычислительной Математики и Кибернетики Московского государственного университета имени М.В.Ломоносова}\en{CMC MSU} -- 
        \ru{Разработчик}\en{Engineer}}
        {\ru{Разработка на Python}\en{Python development}: 
        	\begin{itemize}
	...
	\section{\ru{Образование}\en{Education}}
        ...
        \ru{Перспективные методы искусственного интеллекта в сетях передачи и обработки данных (кафедра АСВК)}\en{Advanced Methods of Artificial Intelligence in Data Transmission and Processing Networks. (Department of Computer Systems and Automation)}
        }
